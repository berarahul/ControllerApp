              ...
              return Column(
                ...
                children: [
                  DropdownButtonFormField<Department>(
                    ...
                    items: departmentController.departments.map((Department department) {
                  ...
                  ElevatedButton(
                    onPressed: selectedDepartment.value == null ? null : () async {
                      // Prepare the request body
                      final requestBody = {
                        'teacherId': teacher.id,
                      ...
                      // Optional: Handle error, show a message if necessary
                      if (!response.isSuccess) {
                        Get.snackbar('Error', 'Failed to add department to teacher');
                      }
                    },
                    child: Text('Done'),
                  ),
