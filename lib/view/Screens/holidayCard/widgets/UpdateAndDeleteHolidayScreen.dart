...
//                   subtitle: Text(
//                       '${holiday.startDate.toLocal()} - ${holiday.endDate
//                           .toLocal()}'),
...
//         text: holiday.startDate.toLocal().toString().split(' ')[0]);
//     TextEditingController endDateController = TextEditingController(
//         text: holiday.endDate.toLocal().toString().split(' ')[0]);
//
//     showDialog(
//       context: context,
//       builder: (context) {
...
//                       selectedDate != holiday.startDate) {
